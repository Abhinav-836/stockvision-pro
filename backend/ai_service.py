...
class OpenRouterAIService:
    ...
    async def query(self, 
        ...
        try:
            ...
            try:
                # Fixed: Use asyncio.to_thread for Python 3.9+ compatibility
...
Return ONLY valid JSON."""
    ...
    def _fallback_thesis(self, stock_data: Dict) -> Dict:
        ...
        if pe and isinstance(pe, (int, float)) and pe < 20:
        ...
        if div and isinstance(div, (int, float)) and div > 2:
        ...
        if debt and isinstance(debt, (int, float)) and debt > 1.5:
